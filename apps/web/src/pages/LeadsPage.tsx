...
export const LeadsPage: React.FC = () => {
  ...
  const fetchLeads = useCallback(async () => {
    ...
    try {
      ...
      setLeads(items);
      setTotalCount(data?.meta?.total || items.length || 0);
      ...
      setError(
        err?.response?.data?.message ||
          "Unable to retrieve leads database records. Verify your connection or try again."
      );
    } finally {
      setIsLoading(false);
    }
    ...
    <div className="space-y-5">
      ...
      {error ? (
        ...
        <EmptyState
          ...
          description={
            search || websiteFilter !== "ALL" || statusFilter !== "ALL" || cityFilter !== "ALL"
              ? "No leads matched your specific filter criteria. Try resetting filters or searching a different term."
